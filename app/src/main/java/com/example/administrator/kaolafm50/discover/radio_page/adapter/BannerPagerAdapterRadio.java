 ...
 */
public class BannerPagerAdapterRadio extends PagerAdapter{

    private List<SpecialInRadio> list;
    private List<ImageView> imageViews;
    public BannerPagerAdapterRadio(List<SpecialInRadio> list, List<ImageView> imageViews) {
        this.list=list;
